...
This is Python - Inheritance ALX project. It is about Python class inheritance; the differences between super- and sub-classes while practicing inheritance; definining classes with multiple base classes, and overiding inherited methods and attributes.
