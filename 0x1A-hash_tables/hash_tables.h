 ...
 * The key is unique for the HashTable
 ...
 * @array: An array of size for @size
 * A cell each of this array is a pointer to the first node of a linked list,
 * so that the HashTable can use a Chaining collision handling
 */
